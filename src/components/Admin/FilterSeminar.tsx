...
const FilterSeminar: React.FC = () => {
    ...
    const fetchUserData = async () => {
        ...
        if (token) {
            ...
            const responseFilter = await axios.get(`/form-tools/faip-form/form-rule?uid=${userId}&ft=seminar`,config);
            // Validate selected values against allOptions
            const filterData = responseFilter.data.data.mk_seminar
    ...
    const onFinish = async () => { //fungsi submit form //NEED API POST
        ...
        if (token) {
            ...
            await axios.patch(`/form-tools/faip-form/filtering?uid=${userId}&ft=seminar`,formData,config);
        } else {
            console.error('User not found');
        }
        }catch(error){
...
<div>
    ...
    <h4 style={{margin:"0 0 10px"}}>CPMK 1. Mahasiswa mampu menjelaskan tentang pengertian dan sistematika tentang karya tulis ilmiah sesuai dengan aturan yang berlaku. </h4>
    <p>Tampilan Pilihan: <span style={{color:"blue",fontWeight:"bold"}}>{selectedChoicesOne}</span></p>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 2. Mahasiswa mampu menjelaskan kaidah dan teknik penulisan karya ilmiah sesuai dengan aturan yang berlaku. </h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 3. Mahasiswa mampu menjelaskan teknik diskusi dan moderasi sesuai dengan aturan yang berlaku.</h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 4. Mahasiswa mampu menjelaskan teknik visualisasi sesuai dengan aturan yang berlaku. </h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 5. Mahasiswa mampu menjelaskan sistematika dan teknik presentasi </h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 6. Mahasiswa mampu menyusun makalah ilmiah sesuai bidang keinsinyuran. </h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 7. Mahasiswa mampu melakukan diskusi sesuai aturan dan etika. </h4>
        ...
        <h4 style={{margin:"10px 0"}}>CPMK 8. Mahasiswa mampu mempresentasikan makalah ilmiah sesuai bidang keinsinyuran. </h4>
